      ...
      <div id="body" className="md:pt-0 pt-[3.5rem] xl:w-4/6 mx-auto md:px-5">
        ...
        >
          <iframe
            ...
            src="https://www.youtube.com/embed/IxF55qB4CuQ?autoplay=1&controls=0&mute=1&loop=1&playlist=IxF55qB4CuQ"
          ...
          <div className="grid md:grid-cols-2 gap-4 w-full mt-4">
            <div className="p-5 rounded-xl border duration-300 md:hover:shadow-xl cursor-pointer">
              ...
              <p>
                ...
                Deserunt dolorem velit laudantium, architecto ipsum iusto labore
                odit optio doloribus unde illo pariatur molestiae officiis
                consectetur quos a beatae reprehenderit! Sapiente.
              </p>
            </div>
            <div>
              <img
